...
export const aiApi = baseApi.injectEndpoints({
    endpoints: (build) => ({
        ...
        copilotFromText: build.mutation({
            query: (text) => {
        ...
        copilotFromFile: build.mutation({
            query: (file) => {
                const form = new FormData();
...
export const { useGetAIAnalysisQuery, useRunPipelineMutation, useCopilotFromTextMutation, useCopilotFromFileMutation, } = aiApi;
